...
git clone https://github.com/eash123-glitch/TeamSorry.git
cd TeamSorry

# Create and activate environment
conda create -n teamsorry python=3.9 -y
conda activate teamsorry
...
📊 Results Overview
Model Variant	Dataset Used	Tasks	Sentence Sim.	ROUGE	METEOR	Accuracy
...
🧠 Key Features
Unified multi-task architecture — jointly learns grounding and question answering

Automatic data generation — powered by LLMs to reduce manual annotation

Supports both OpenQA and CloseQA with consistent evaluation
